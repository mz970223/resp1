		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="${pageContext.request.contextPath}/syslog/findByPage?pageNo=1&rows=${pageInfo.pageSize}"
								   aria-label="Previous">首页</a></li>
							<li>
								<a href="${pageContext.request.contextPath}/syslog/findByPage?pageNo=${pageInfo.pageNum-1}&rows=${pageInfo.pageSize}">上一页</a>
							</li>

							<%--pages : 10    1-10  --%>
							<c:forEach begin="1" end="${pageInfo.pages}" var="num">
								<li <c:if test="${num==pageInfo.pageNum}">class="active"</c:if> ><a
										href="${pageContext.request.contextPath}/syslog/findByPage?pageNo=${num}&rows=${pageInfo.pageSize}">${num}</a>
								</li>
							</c:forEach>

							<li>
								<a href="${pageContext.request.contextPath}/syslog/findByPage?pageNo=${pageInfo.pageNum+1}&rows=${pageInfo.pageSize}">下一页</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/syslog/findByPage?pageNo=${pageInfo.pages}&rows=${pageInfo.pageSize}"
